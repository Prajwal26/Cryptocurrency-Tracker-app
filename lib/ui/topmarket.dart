                ...
                children: <Widget>[
                  Row(
                    children: <Widget>[
                      Container(
                        width: 20.0,
                        child: Text('#',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white,fontFamily: 'RobotoBold'),textAlign: TextAlign.center,),
                      ),
                      Container(
                        width: widthFinal,
                        child: Text('Exchange',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white,fontFamily: 'RobotoBold'),textAlign: TextAlign.center,),
                      ),
                      Container(
                        width: widthFinal,
                        child: Text('Pair',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white,fontFamily: 'RobotoBold'),textAlign: TextAlign.center,),
                      ),
                      Container(
                        width: widthFinal,
                        child: Text('Price',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white,fontFamily: 'RobotoBold'),textAlign: TextAlign.center,),
                      )
                    ],
                  ),
                      ...
                      return Column(
                        ...
                        children: <Widget>[
                          Container(
                            width: 20.0,
                            child: FittedBox(
                              child: Text('${index+1}',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),textAlign: TextAlign.center,),
